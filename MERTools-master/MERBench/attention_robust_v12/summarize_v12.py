...
def main():
    parser = argparse.ArgumentParser(
        description="Summarize v11 runs into Train&Val / MER-MULTI / MER-NOISE / MER-SEMI table format."
    )
    parser.add_argument(
        "--root",
        type=Path,
        default=Path("attention_robust_v11/outputs/results"),
        help="root directory containing run outputs",
    )
    parser.add_argument(
        "--out_csv",
        type=Path,
        default=Path("attention_robust_v11/outputs/summary/summary.csv"),
