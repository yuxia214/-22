...
case "${CASE_ID}" in
    g1)
        # Regression-main branch based on v15 (historically lower MSE than v21 branches).
        ...
        ;;
    g2)
        # Strong valence branch on v2 with longer regression-head finetune.
        MODEL_NAME="attention_robust_v2"
        EPOCHS_DEFAULT="130"
        EXTRA_ARGS=(
            "${BASE_ARGS[@]}"
        ...
        ;;
    g3)
        # Group-calibration branch on v14 to reduce emotion-dependent valence bias.
        ...
        ;;
    g4)
        # F1 anchor branch to keep class discrimination strong.
