'''
AttentionRobustV12 - 基于P-RMF的概率化多模态融合模型
...
class AttentionRobustV12(nn.Module):
    """
    AttentionRobustV12 - 概率化多模态情感识别模型
    ...
    def __init__(self, args):
        super(AttentionRobustV12, self).__init__()
