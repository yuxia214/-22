...
if __name__ == '__main__':
    ...
    parser.add_argument('--savemodel', action='store_true', default=True, help='whether to save model')
    ...
    for ii in range(len(train_loaders)):
        ...
        if args.savemodel and best_model_state is not None:
            save_path = f'{save_modelroot}/{prefix_name}_fold{ii+1}_{name_time}.pth'
